...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname |Intro 2 Final Exam|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
; Final Exam | Dimitri Short, Kyle Dunn, Derek Diskant
...
(define (radix-timing n) 
  (cond [(> n 20000) (void)] 
        [else (begin
                ...
                (newline)
                (time (radix-sort! (build-vector n (lambda (i) (random 1000000)))))
                (newline)
                (radix-timing (+ n 500)))]))
...
(define (insertion-timing n) 
  (cond [(> n 20000) (void)] 
        [else (begin
                ...
                (newline)
                (time (insertion-sort! (build-vector n (lambda (i) (random 1000000)))))
                (newline)
